...
enyo.kind({
  ...
  components: [
    ...
    {kind: 'Accordion', components: [
      ...
      //     {kind: 'onyx.Groupbox', components: [
      //         {name: 'articleExtraction', kind: 'SettingsValueItem', defaultInputKind: 'SettingsToggleButton',
      ...
      {content: 'Local Storage', components: [
        {kind: 'onyx.Groupbox', components: [
          {name: 'clearSettings', kind: 'SettingsActionItem', label: 'Restore Default Settings', buttonLabel: 'Restore',
          ...
          // {name: 'exportSettings', kind: 'SettingsActionItem', label: 'Export Settings', buttonLabel: 'Export',
          //   onActivated: 'exportSettings'},
          // {name: 'importSettings', kind: 'SettingsActionItem', label: 'Import Settings', buttonLabel: 'Import',
          //   onActivated: 'importSettings'}
        ]}
      ]},
      {content: 'Permissions', components: [
        {kind: 'onyx.Groupbox', components: [
          {name: 'revokeEvernotePermissions', kind: 'SettingsActionItem', classes: 'k2e-settings-item-caution',
            label: 'Revoke Evernote permissions', buttonLabel: 'Revoke', buttonClasses: 'k2e-caution-button',
            onActivated: 'revokeEvernotePermissions', cookieModel: undefined,
            computed: [
