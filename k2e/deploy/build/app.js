...
enyo.path.addPaths({layout: "C://Users/katopod/Documents/Visual Studio 2010/Projects/k2e/k2e/bootplate/enyo/tools/../../lib/layout/", onyx: "C://Users/katopod/Documents/Visual Studio 2010/Projects/k2e/k2e/bootplate/enyo/tools/../../lib/onyx/", onyx: "C://Users/katopod/Documents/Visual Studio 2010/Projects/k2e/k2e/bootplate/enyo/tools/../../lib/onyx/source/"});
...
var e = 0, t = this.length, n, r;
if (this.length === 0) return e;
for (n = 0; n < t; n += 1) r = this.charCodeAt(n), e = (e << 5) - e + r, e &= e;
return e;
};
...
p: function() {
this.lock -= 1, this.lock === 0 && this.func && this.func();
}
});
...
arguments.callee.singletonInstance = this, this.defaultSettings = new DefaultSettings;
var e = this, t = function(t) {
return e.defaultSettings[t] ? !0 : !1;
};
this.getSetting = function(e) {
if (!t(e)) return null;
var n = localStorage[e] ? JSON.parse(localStorage[e]) : JSON.parse(this.defaultSettings[e]);
return n;
}, this.getDefaultSetting = function(e) {
if (t(e)) {
var n = JSON.parse(this.defaultSettings[e]);
return n;
}
return null;
};
...
var t = {}, n;
for (n = 0; n < e.length; n += 1) t[e[n]] = !0;
return t;
};
return {
name: "k2e.App",
...
name: "clipping_picker_popup",
kind: "ClippingPickerPopup"
}, {
name: "export_popup",
kind: "ExportPopup"
}, {
...
components: [ {
tag: "i",
classes: "icon-reorder icon-large",
content: " "
}, {
tag: "span",
content: "Settings"
...
components: [ {
fit: !0,
name: "document_selector_list",
kind: "DocumentSelectorList"
} ]
}, {
kind: "FittableRows",
classes: "k2e-main-panel",
fit: !0,
components: [ {
name: "to_top_button",
...
components: [ {
tag: "i",
classes: "icon-chevron-up icon-large"
} ]
}, {
...
this.$.settings.isAtMax() && this.toggleSettings(), this.$.sidebar.setShowing(!this.$.sidebar.showing), this.$.app_toolbar.setShowing(!this.$.app_toolbar.showing), this.resized();
},
toggleFullscreen: function() {
var e = this.hasNode(), t = document.webkitIsFullScreen || document.mozFullscreen || document.fullscreen;
e && (t ? document.webkitExitFullscreen ? document.webkitExitFullscreen() : document.mozCancelFullScreen ? document.mozCancelFullScreen() : document.exitFullscreen() : e.webkitRequestFullscreen ? e.webkitRequestFullscreen(Element.ALLOW_KEYBOARD_INPUT) : e.mozRequestFullScreen ? e.mozRequestFullScreen() : e.requestFullscreen());
},
exportDocuments: function(e, n) {
this.log("Export processing done");
var r = location.protocol + "//" + location.host + location.pathname, i = new enyo.Ajax({
url: r + "/Export",
contentType: "application/json; charset=utf-8",
method: "POST",
postBody: '{"q":' + JSON.stringify(t, null, 0) + "}"
});
console.log(r), console.log(t), i.go(), i.response(this, "processExportResponse"), i.error(this, "processExportError");
},
processExportResponse: function(e, t) {
var n = this;
alert(JSON.stringify(t, null, 2)), this.$.export_popup.exportDone(), window.setTimeout(function() {
n.$.export_popup.hide();
}, 2e3);
},
processExportError: function(e, t) {
this.error("Error in exporting");
},
prepareDocumentsAndExport: function() {
this.$.export_popup.exportBegin(), this.$.export_popup.show(), this.handleExportBegin();
var e = SettingsSingletonInstance(), r = {}, i = e.getSetting("ignoredTitleList"), s, o = {}, u, a = this;
i.length > 0 && (r = n(i.split(","))), t = this.documents.exportObject(r), s = t.documents, u = e.getSetting("periodicalTitleList"), u.length > 0 && (o = n(u.split(","))), function() {
var t, n, r, i;
for (i = 0; i < s.length; i += 1) {
t = s[i];
if (e.getSetting("articleExtraction") === !0) {
a.log("Tagging documents as periodicals");
if (o.hasOwnProperty(t.title)) {
t.isPeriodical = !0;
for (r = 0; r < t.clippings.length; r += 1) n = t.clippings[r], a.setSuggestedDataToClipping(n);
}
}
}
}(), this.handleExportEnd();
},
setSuggestedDataToClipping: function(e, t, n) {
var r = this, i = SettingsSingletonInstance(), s = t === undefined ? !0 : t, o = n === undefined ? !0 : n, u = i.getSetting("googleSearchApiLoc"), a = i.getSetting("googleSearchApiKey"), f = i.getSetting("googleSearchApiCx"), l = 128, c = "", h = "", p, d, v;
e.content.length > l ? c = e.content.substring(0, l) : c = e.content, p = c.lastIndexOf(" "), p !== -1 ? h = c.substring(0, p) : h = c, h = s ? '"' + h + '"' : h, d = new enyo.Ajax({
url: u
}), this.handleQueryBegin(), d.go({
key: a,
cx: f,
q: h
}), v = function(t, n) {
var i = e;
n.items && n.items.length ? (i.suggestedTitle = n.items[0].title, i.suggestedUrl = n.items[0].link, r.log("Got title: " + n.items[0].title), r.handleQueryEnd()) : (r.handleQueryEnd(), o && r.setSuggestedDataToClipping(i, !1, !1));
}, d.response(v), d.error(this, "processQueryError");
},
processQueryError: function(e, t) {
this.error("Error in google search request"), this.handleQueryEnd();
},
scrollDocumentToTop: function(e, t) {
this.$.document_scroller.scrollToTop();
},
handleDocumentSelected: function(e, t) {
var n, r;
n = t.originator, console.log(n.getTitle()), console.log(n.getIndex()), r = this.documents.getDocumentByIndex(n.getIndex()), console.log(r), this.$.document_view.displayDocument(r), this.$.document_scroller.setScrollTop(0), this.$.document_scroller.setScrollLeft(0);
},
handleDocumentScrolled: function(e, t) {
var n = t.bounds, r = t.scrollBounds, i, s, o = 10;
i = n.width - r.clientWidth + o, s = n.height - r.clientHeight + o, this.$.to_top_button.applyStyle("right", i + "px"), this.$.to_top_button.applyStyle("bottom", s + "px"), r.top === 0 ? this.$.to_top_button.applyStyle("display", "none") : this.$.to_top_button.applyStyle("display", "block");
},
handleExportBegin: function(t, n) {
this.log("handleExportBegin"), e.v();
},
handleExportEnd: function(t, n) {
this.log("handleExportEnd"), e.p();
},
handleQueryBegin: function(t, n) {
this.log("handleQueryBegin"), e.v();
},
handleQueryEnd: function(t, n) {
this.log("handleQueryEnd"), e.p();
},
handleClippingsTextChanged: function(e, t) {
this.log("handleClippingsTextChanged");
var n = this.$.clipping_picker_popup.getClippingsText();
this.documents = this.parseKinldeClippings(n), this.$.document_selector_list.populate(this.documents), this.$.clipping_picker_popup.hide();
},
handleKeydown: function(e, t) {
return this.log(e), this.log(t), t.keyCode === 70 ? this.toggleFullscreen() : t.keyCode === 74 ? this.$.document_selector_list.selectNextDocument() : t.keyCode === 75 && this.$.document_selector_list.selectPrevDocument(), !0;
},
handleFullscreenRequest: function(e, t) {
this.toggleFullscreen();
},
toggleSettings: function(e, t) {
var n = this.$.settings_button;
n.addRemoveClass("active", !n.hasClass("active")), this.$.settings.toggle();
},
parseKinldeClippings: function(e) {
var t = new Documents, n = new RegExp(/^\s*(.+)\s\((.+)\)\s+-\s+(.+)\s+(.*)/), r = "==========";
return e = e.split("\n" + r), function() {
var r, i, s, o, u, a, f, l, c;
for (r = 0; r < e.length; r += 1) n.test(e[r]) && (i = n.exec(e[r]), s = i[1], o = i[2], u = i[3].split(/\s+\|\s+/), a = u[0].substring(0, u[0].indexOf(" ")), f = u[0].substring(u[0].indexOf(" ") + 1), l = u[u.length - 1], c = i[4], a !== "Bookmark" && a !== "Clipping" && t.addClippingToDocument(s, o, new Clipping({
type: a,
loc: f,
timeStamp: l,
content: c
...
reflow: function() {
this.inherited(arguments), enyo.Panels.isScreenNarrow() ? this.$.document_view.setContent("isScreenNarrow") : this.$.document_view.setContent("notScreenNarrow");
},
rendered: function() {
this.inherited(arguments), this.$.clipping_picker_popup.show();
},
create: function() {
this.inherited(arguments);
var t = this;
e = new AsyncSemaphore({
func: function() {
t.exportDocuments();
}
}), document.onwebkitfullscreenchange = document.onmozfullscreenchange = document.onfullscreenchange = function() {
t.toggleDistractionFreeMode();
};
}
};
}());
...
handleDocumentSelected: function(e, t) {
var n = t.originator;
if (this.selDocumentSelectorItem === n) return !0;
n.setSelected(!0), this.selDocumentSelectorItem && this.selDocumentSelectorItem.setSelected(!1), this.selDocumentSelectorItem = n;
},
handleSetupItem: function(e, t) {
var n = t.index, r = t.item, i = this.documentsRef.getDocMap(), s = this.documentsRef.getKeyArray()[n];
return r.$.documentSelectorItem.setTitle(i[s].getTitle()), r.$.documentSelectorItem.setIndex(n), this.items.push(r.$.documentSelectorItem), !0;
},
enableMultiSelection: function() {
var e;
for (e = 0; e < this.items.length; e += 1) this.items[e].setMultiSelected(!0);
},
disableMultiSelection: function() {
var e;
for (e = 0; e < this.items.length; e += 1) this.items[e].setMultiSelected(!1);
},
selectNextDocument: function() {
var e, t;
this.items.length !== 0 && (this.selDocumentSelectorItem ? (e = this.selDocumentSelectorItem.getIndex(), e >= 0 && e < this.items.length - 1 && (e += 1, t = this.items[e], t.doDocumentSelected()), this.log(this.selDocumentSelectorItem.getIndex())) : (t = this.items[0], t.doDocumentSelected()));
},
selectPrevDocument: function() {
var e, t;
this.items.length !== 0 && (this.selDocumentSelectorItem ? (e = this.selDocumentSelectorItem.getIndex(), e >= 1 && e < this.items.length && (e -= 1, t = this.items[e], t.doDocumentSelected()), this.log(this.selDocumentSelectorItem.getIndex())) : (t = this.items[this.items.length - 1], t.doDocumentSelected()));
},
populate: function(e) {
this.documentsRef = e, this.$.DocumentSelectorRepeater.setCount(this.documentsRef.length);
},
create: function() {
this.inherited(arguments), this.items = [];
}
}), enyo.kind({
...
name: "label",
classes: "enyo-inline k2e-document-selector-item-label"
} ],
events: {
onDocumentSelected: ""
},
...
this.selected = e, this.addRemoveClass("onyx-selected", this.selected), this.addRemoveClass("onyx-blue", this.selected);
},
setTitle: function(e) {
...
setMultiSelected: function(e) {
e === !0 ? (this.multiSelected = !0, this.$.checkbox.setChecked(!1), this.$.checkbox.show()) : e === !1 && (this.multiSelected = !1, this.$.checkbox.hide(), this.$.checkbox.setChecked(!1));
}
});
...
addClipping: function(e) {
this.getClippings().push(e);
},
create: function() {
this.inherited(arguments), this.clippings = [];
},
exportObject: function() {
var e = [], t, n;
for (n = 0; n < this.clippings.length; n += 1) t = this.clippings[n].exportObject(), e.push(t);
return {
title: this.title,
author: this.author,
...
addClippingToDocument: function(e, t, n) {
var r = e + t;
this.docMap[r] || (this.docMap[r] = new Document({
title: e,
author: t
}), this.length += 1, this.keyArray.push(r)), this.docMap[r].addClipping(n);
},
getDocumentByIndex: function(e) {
return this.docMap[this.keyArray[e]];
},
create: function() {
this.inherited(arguments), this.docMap = {}, this.keyArray = [];
},
...
for (n = 0; n < this.keyArray.length; n += 1) r = this.docMap[this.keyArray[n]], e.hasOwnProperty(r.title) || (i = r.exportObject(), t.documents.push(i));
return t;
}
});
...
components: [],
displayDocument: function(e) {
function r(e, n) {
var r = e.clippings[n].loc, i = e.clippings[n].type, s = e.clippings[n].timeStamp, o = e.clippings[n].content;
t.createComponent({
classes: "k2e-document-view-clip-header",
components: [ {
tag: "i",
content: i + ", " + r
}, {
...
var t = this, n;
this.clearDocument(), this.createComponent({
tag: "h1",
content: e.title
}), this.createComponent({
classes: "k2e-document-view-subtitle",
components: [ {
tag: "i",
content: "by "
}, {
...
if (e.clippings.length !== 0) {
r(e, 0);
for (n = 1; n < e.clippings.length; n += 1) this.createComponent({
classes: "k2e-document-view-clip-separator"
}), r(e, n);
}
this.render();
},
...
toggle: function() {
this.addRemoveClass("k2e-settings-active", this.isAtMin()), this.isAtMin() ? this.animateToMax() : (this.animateToMin(), this.$.scroller.scrollToTop());
}
});
...
kind: "onyx.Groupbox",
components: [ {
name: "ignoredTitleList",
kind: "SettingsValueItem",
defaultInputKind: "SettingsTextInput",
label: "Titles to Ignore"
} ]
} ]
}, {
...
kind: "SettingsValueItem",
defaultInputKind: "SettingsToggleButton",
label: "Periodical Article Extraction",
onSettingChanged: "handleExtractionSettingChanged"
}, {
name: "periodicalTitleList",
kind: "SettingsValueItem",
inputComponent: {
...
name: "googleSearchApiCx",
kind: "SettingsValueItem",
defaultInputKind: "SettingsTextInput",
label: "Google Search Api Cx",
disabled: !SettingsSingletonInstance().getSetting("articleExtraction")
}, {
name: "googleSearchApiLoc",
kind: "SettingsValueItem",
defaultInputKind: "SettingsTextInput",
label: "Google Search Api Url",
disabled: !SettingsSingletonInstance().getSetting("articleExtraction")
} ]
} ]
}, {
...
handleSettingChanged: function(e, t) {
var n = t.originator;
return this.log(n.getValue()), this.log(n.getName()), localStorage[n.getName()] = JSON.stringify(n.getValue()), !0;
},
handleExtractionSettingChanged: function(e, t) {
this.$.periodicalTitleList && this.$.googleSearchApiKey && this.$.googleSearchApiCx && this.$.googleSearchApiLoc && (this.$.periodicalTitleList.setDisabled(!t.originator.getValue()), this.$.googleSearchApiKey.setDisabled(!t.originator.getValue()), this.$.googleSearchApiCx.setDisabled(!t.originator.getValue()), this.$.googleSearchApiLoc.setDisabled(!t.originator.getValue()));
},
restoreDefaults: function() {
this.log("restore defaults"), localStorage.clear();
var e = SettingsSingletonInstance(), t = e.defaultSettings.published, n;
for (n in t) t.hasOwnProperty(n) && this.$[n].setValue(e.getDefaultSetting(n));
},
...
rendered: function() {
this.inherited(arguments), this.labelChanged(), this.disabledChanged();
}
}), enyo.kind({
...
valueChanged: function() {
this.log(this), this.$.input.setValue(this.value);
},
disabledChanged: function() {
this.inherited(arguments), this.$.input.setDisabled(this.disabled);
},
handleInputValueChanged: function(e, t) {
return this.doSettingChanged(), !0;
},
create: function() {
this.inherited(arguments), this.createComponent({
fit: !0
}), this.inputComponent ? (this.inputComponent.name = "input", this.createComponent(this.inputComponent)) : this.createComponent({
name: "input",
kind: this.defaultInputKind
}), this.value = SettingsSingletonInstance().getSetting(this.getName()), this.valueChanged();
},
rendered: function() {
this.inherited(arguments), this.resized();
}
...
return this.value = this.getValue(), this.doInputValueChanged(), !0;
},
...
create: function() {
this.inherited(arguments), this.typeChanged(), this.placeholderChanged();
}
}), enyo.kind({
...
handleActivate: function(e, t) {
return t.originator.getActive() && (this.log(t.originator.getContent()), this.value = t.originator.getContent()), this.doInputValueChanged(), !0;
},
valueChanged: function() {
this.log(this.getComponents());
var e = this.getComponents(), t;
for (t = 1; t < e.length; t += 1) if (e[t].getContent() === this.value) return e[t].setActive(!0), this.doInputValueChanged(), !0;
this.$.group.getActive() ? this.value = this.$.group.getActive().getContent() : this.value = "", this.log(this.value);
},
disabledChanged: function() {
var e = this.getComponents(), t;
for (t = 1; t < e.length; t += 1) e[t].setDisabled(this.disabled);
}
});
...
loadFile: function() {
var e = this.$.file_picker.hasNode();
e && e.click();
},
...
var e = this, t = this.hasNode(), n = this.$.file_picker.hasNode(), r, i, s, o, u;
t && n && (r = function(t) {
e.addRemoveClass("onyx-blue", !1);
}, i = function(t) {
e.addRemoveClass("onyx-blue", !0), t.stopPropagation(), t.preventDefault(), t.dataTransfer.dropEffect = "copy";
}, s = function(t) {
var n = new FileReader;
t.length > 0 && (n.onload = function(t) {
e.setClippingsText(t.target.result);
}, n.readAsText(t[0]));
}, o = function(t) {
t.stopPropagation(), t.preventDefault(), e.addRemoveClass("onyx-blue", !1), s(t.dataTransfer.files);
}, u = function() {
s(this.files);
}, n.addEventListener("change", u, !1), t.addEventListener("dragleave", r, !1), t.addEventListener("dragover", i, !1), t.addEventListener("drop", o, !1));
}
});
...
name: "message",
content: "Exporting clippings..."
} ],
exportDone: function() {
this.$.spinner.hide(), this.$.message.setContent("Export Done!");
},
exportBegin: function() {
this.$.spinner.show(), this.$.message.setContent("Exporting clippings...");
}
});
...
childComponents: [ {
name: "header",
classes: "onyx-toolbar-inline k2e-accordion-item-header",
style: "height: 36px",
ontap: "toggleOpen",
components: [ {
name: "animation",
...
name: "expander",
style: "background-color: inherit; width: 36px; height: 100%; margin: 0;",
components: [ {
tag: "img",
src: "assets/accordion_collapsed.png"
} ]
}, {
classes: "k2e-accordion-item-content",
style: "height: 100%; margin: 0;",
components: [ {
name: "header_text",
content: "Heading",
style: "display: table-cell; vertical-align: middle; height: 36px"
} ]
} ]
}, {
name: "client",
...
initComponents: function() {
this.createComponents(this.childComponents, {
isChrome: !0
}), this.inherited(arguments);
},
contentChanged: function() {
...
this.$.client.setOpen(!this.$.client.getOpen()), this.$.animation.isAnimating() ? this.$.animation.reverse() : this.$.client.getOpen() ? this.$.animation.play({
startValue: 0,
endValue: 90,
node: this.$.expander.hasNode()
}) : this.$.animation.play({
startValue: 90,
endValue: 0,
node: this.$.expander.hasNode()
...
return this.$.expander.applyStyle("-webkit-transform", "rotate(" + e.value + "deg)"), this.$.expander.applyStyle("-ms-transform", "rotate(" + e.value + "deg)"), this.$.expander.applyStyle("-moz-transform", "rotate(" + e.value + "deg)"), this.$.expander.applyStyle("-o-transform", "rotate(" + e.value + "deg)"), this.$.expander.applyStyle("transform", "rotate(" + e.value + "deg)"), !0;
},
animatorComplete: function(e, t) {
return !0;
}
});
...
onScrollHandler: function(e, t) {
var n = this.getBounds(), r = this.getScrollBounds();
