...
describe('Enyo deploy walker', () => {
  ...
  describe('has a getDependencies function that', () => {
    ...
    it('should extract dependency paths (*.js, *.css, *.less) from a package.js file present in the given directory', () => {
      mockFs({
        '/enyoProject': {
          'source': {
            'script1.js': '',
          ...
          'package.js': 'enyo.depends("source/script1.js", "source/script2.js", "source/css1.css")'
        }
      });
      let deps = walker.getDependencies('/enyoProject');
    ...
    it('should recursively read package.js files from extensionless names (directories by convention)' +
      'in a package.js file present in the given directory', () => {
        mockFs({
          '/enyoProject': {
            'source': {
              style: {
    ...
    it('should ignore dependency paths that have file extensions and do not end in .js, .css, and .less)', () => {
      mockFs({
        '/enyoProject': {
          'source': {
            'ignore.html': '',
          ...
          'package.js': 'enyo.depends("source/ignore.html", "source/ignore.me", "source/ignore.design")'
        }
      });
      let deps = walker.getDependencies('/enyoProject');
    ...
    it('should extract dependency paths and assets (any file or directory) from a deploy.json file present in the given directory', () => {
      mockFs({
        '/enyoProject': {
          'source': {
            'script.js': ''
          ...
          'deploy.json': '{ "packagejs": "./package.js", "assets": ["./assets/icon.png"] }'
        }
      });
    ...
    it('should ignore properties other than assets and packagejs from deploy.json files', () => {
      mockFs({
        '/enyoProject': {
          ...
          'another-package.js': 'enyo.depends("source/script.js")',
          'package.js': 'garbage',
          'deploy.json': '{ "packagejs": "./another-package.js", "assets": ["./assets/icon.png"], "libs": ["1", "2"] }'
        }
      });
    ...
    it('should normalize the dependency paths returned', () => {
      mockFs({
        '/enyoProject': {
          ...
          'deploy.json': '{ "packagejs": "./package.js", "assets": ["./assets/onemorelevel/../icon.png"] }'
        }
      });
    ...
    it('should throw an exception if the directory given does not contain a package.js or a deploy.json file', () => {
      mockFs({
        '/enyoProject': {
          'source': {
            'script.js': ''
  ...
  describe('has a createDependencyCollection function that', () => {
    it('creates a dependency collection object, that contains exactly three empty arrays: scripts, assets, and css', () => {
      let deps = walker.createDependencyCollection();
  ...
  describe('has a pushDependecyCollection function that', () => {
    ...
    it('should return the modified dependency collection', () => {
      let deps1 = walker.createDependencyCollection();
      let deps2 = walker.createDependencyCollection();
  ...
  describe('has a mergeDependencyCollections function that', () => {
    it('merges two dependency collections into a new collection', () => {
      ...
      let deps3 = walker.mergeDependencyCollections(deps1, deps2);
